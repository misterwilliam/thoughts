...
the answers. All we have are people’s best guesses, therefore nobody can
justifiable claim moral authority. Nobody really knows the best way to organize
society. Nobody has all the answers to moral questions. This is important to
keep in mind when considering any moral disagreement. The underlying topic is
complicated and nobody has all the answers on the base assumptions.

**Morals are pragmatic, situational and outcome oriented.** The best way to do
anything depends on the consequences. The consequences depend on the situation.
...
Methods of organizing society are implicitly designed to achieve positive
outcomes. The precise nature of what is positive outcome, what is suffering,
what is maximal welfare are not concepts where there is a universal shared
consensus. So defining these terms are part of a moral framework as well as
describing how to achieve the optimization of those factors.
...
welfare and minimizing suffering when compared to social structures which have
been deployed at scale in practice, and yet has no explanation for why we should
value one another.

If we summarize Western liberalism as a philosophy granting all humans the
rights to “life, liberty and the pursuit of happiness”, and capitalism which
manifests an invisible hand that guides welfare maximization, we have no
explanation for why we should value one another. Under this philosophy it
becomes unclear why society should subsidize the welfare of economically
...
[Expected ASI Safety and Morals](drafts/asi_morals.md)
